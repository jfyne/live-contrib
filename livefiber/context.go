...
// FiberCtx gets the initialising *fiber.Ctx from the live context. nil if
...
// FiberConn gets the initialising *werbsocket.Conn from the live context. nil
// if not there or the websocket connection hasn't been established.
func FiberConn(ctx context.Context) *websocket.Conn {
